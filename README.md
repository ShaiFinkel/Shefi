# Shefi & Co. v2 — חברת הסוכנים שלך

> **את ה־CEO. 15 סוכני AI עובדים בשבילך, מחולקים ל־3 חטיבות.**

מערכת אישית עם:
- **בוט טלגרם** — הדלת לחטיבת התפעול
- **דשבורד ווב מקומי** ב־`http://localhost:3000` — שיחת הסוכנים בזמן אמת + אישור דיפים מחטיבת הפיתוח
